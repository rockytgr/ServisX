...
if ($stmt->num_rows === 0) {
    echo "<script>alert('Token tidak sah atau telah tamat.'); window.location='login.html';</script>";
    exit();
}
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav me-3">
          ...
          <li class="nav-item"><a class="nav-link" href="servis.html">Servis</a></li>
          <li class="nav-item"><a class="nav-link" href="hubungin.php">Hubungi Kami</a></li>
        </ul>
  
        <!-- Auth Buttons -->
        <div class="d-flex gap-2">
          <a href="login.html" class="btn btn-outline-success">Log Masuk</a>
          <a href="registerselection.html" class="btn btn-success">Daftar</a>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-6 text-center text-md-start mb-4 mb-md-0">
          <img src="images/Logo.svg" alt="SERVIS-X Logo" style="height: 100px;" />
        </div>

  <section class="col md-6">
    <div class="login-box shadow-sm">
      <h3 class="text-center mb-4">Tetapkan Semula Katalaluan</h3>
      <form action="reset_update.php" method="POST">
        ...
        <div class="mb-3">
          <label for="confirm" class="form-label">Sahkan Katalaluan</label>
          <input type="password" class="form-control" id="confirm" name="confirm_password" required>
        </div>
        <button type="submit" class="btn btn-dark w-100 py-2">Simpan Katalaluan</button>
      </form>
    </div>
  </div>
</section>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-4 mb-3 mb-md-0">
          <ul class="footer-links list-inline mb-0 text-center">
            <li class="list-inline-item"><a href="index.html" class="text-white text-decoration-none">Utama</a></li>
            <li class="list-inline-item"><a href="tentangkami.html" class="text-white text-decoration-none">Tentang Kami</a></li>
            <li class="list-inline-item"><a href="servis.html" class="text-white text-decoration-none">Servis</a></li>
